...
urlpatterns = [
    ...
    path('demographics/1/', views.DemographicsFormView.as_view(template_name='demographics.html'), name='demographics'),

    path('encounters/1/', views.EncountersFormView.as_view(template_name='encounters.html'), name='encounters'),
